...
for i, example in enumerate(dataset['test']):  # Change the slice as needed
    input_text = example['messages'][0]["content"][1]["text"]  # Adjust based on the dataset format
    ...
    expected_output = example['messages'][1]["content"][0]["text"]  # Adjust based on the dataset format
